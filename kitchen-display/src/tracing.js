...
// → localhost:3001      → http://localhost:4318/v1/traces (port-forward)
// → kitchen.timourhomelab.org → https://otel.timourhomelab.org/v1/traces (Ingress)
...
// → service.name = "kitchen-display" (erscheint in Jaeger Service Liste)
const resource = Resource.default().merge(
  new Resource({
    [ATTR_SERVICE_NAME]: 'kitchen-display',
...
console.log('Service: kitchen-display');
