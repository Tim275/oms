...
func (s *StockGrpcHandler) ReserveStock(ctx context.Context, req *pb.ReserveStockRequest) (*pb.ReserveStockResponse, error) {
	reservationID, err := s.service.ReserveStock(ctx, req.OrderID, req.Items)
	if err != nil {
		return nil, err
	}
