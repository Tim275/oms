...
CREATE TABLE stock_reservations (
    ...
    reservation_id VARCHAR(255) NOT NULL,         -- UUID for grouping items in same reservation
    ...
    -- Unique constraint: one reservation_id can have multiple items, but each item only once
